      ...
      <section className="home-hero">
        <div className="container home-hero-grid">
          <div className="home-hero-copy">
            <p className="eyebrow">LRS DAKTECHNIEK · BREDA</p>
            <h1>Uw dak duidelijk.<span>Van probleem naar oplossing.</span></h1>
            <p className="hero-intro">Pannendaken, bitumen, isolatie, lekkages en schoorsteen verwijderen. Rechtstreeks contact met LRS.</p>
            <div className="hero-actions"><Link className="button" href="/dakcheck">Start Dakcheck</Link><Link className="button button-secondary" href="/prijsindicatie">Prijsindicatie</Link></div>
            <div className="micro-proof"><div><strong>01</strong><span>Direct contact</span></div><div><strong>02</strong><span>Lokale focus</span></div><div><strong>03</strong><span>Duidelijke prijsroute</span></div></div>
          </div>
          <div className="hero-art">
            <div className="hero-art-grid"/>
            <svg viewBox="0 0 720 560" aria-hidden="true">
              <defs><linearGradient id="roofc" x1="0" x2="1"><stop offset="0%" stopColor="#6f8796"/><stop offset="100%" stopColor="#294b5e"/></linearGradient></defs>
              <path d="M90 300 360 92 630 300Z" fill="url(#roofc)"/><path d="M147 287h426v205H147z" fill="#11171d"/>
              <rect x="316" y="365" width="88" height="127" fill="#070a0d"/><rect x="192" y="352" width="82" height="65" fill="#eef3f5"/><rect x="448" y="352" width="82" height="65" fill="#eef3f5"/>
            </svg>
            <div className="floating-card floating-one"><span>01</span><div><strong>Dakcheck</strong><small>In 60 seconden richting</small></div></div>
            <div className="floating-card floating-two"><span>02</span><div><strong>Prijsindicatie</strong><small>Eerlijke prijsroute</small></div></div>
          </div>
        </div>
      </section>
      <section className="section"><div className="container"><div className="section-title section-title-wide"><div><p className="eyebrow">DIENSTEN</p><h2>Vijf specialismen. Eén aanspreekpunt.</h2></div><p>Kies het onderdeel van uw dak en lees direct waar technisch op gelet wordt.</p></div><div className="service-showcase">{services.map((s,i)=><Link className="service-tile" key={s.slug} href={`/${s.slug}`}><div className="service-tile-top"><span>{String(i+1).padStart(2,"0")}</span><span>↗</span></div><div className="service-word">{s.name.toUpperCase()}</div><p className="eyebrow">{s.eyebrow}</p><h3>{s.name}</h3><p>{s.intro}</p></Link>)}</div></div></section>
      <section className="section section-ink"><div className="container diagnostic-grid"><div className="diagnostic-copy"><p className="eyebrow light">DAKCHECK</p><h2>U hoeft niet zelf de diagnose te kennen.</h2><p>Kies wat u ziet en de website leidt u naar de juiste volgende stap.</p><Link className="button button-light" href="/dakcheck">Doe de Dakcheck</Link></div><div className="diagnostic-screen"><div className="screen-top"><span>DAKCHECK</span><i>LIVE</i></div><div className="screen-line active"><b>01</b><strong>Wat speelt er?</strong><span>→</span></div><div className="screen-line"><b>02</b><strong>Welk daktype?</strong><span>→</span></div><div className="screen-line"><b>03</b><strong>Hoe urgent?</strong><span>→</span></div></div></div></section>
      <section className="section"><div className="container"><div className="price-teaser"><div className="price-teaser-main"><p className="eyebrow light">PRIJSINDICATIE</p><h2>Een bedrag als het betrouwbaar kan.</h2><p>Voor lekkage is een bestaande bandbreedte beschikbaar. Grotere renovaties blijven maatwerk.</p><Link className="button button-light" href="/prijsindicatie">Open prijsindicatie</Link></div><div className="price-teaser-number"><span>LEKKAGE</span><strong>€242 – €423,50</strong><small>incl. btw · huidige indicatie</small></div></div></div></section>
